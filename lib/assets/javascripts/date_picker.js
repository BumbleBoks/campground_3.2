...
DatePicker.prototype.initialize = function(displayDateDiv) {
	this.datePicker = $("#date_picker");
...
DatePicker.prototype.moveDatePickerByAWeek = function(direction) {
	...
	this.setWithCentralDate();
	this.selectDateColumn(this.selectedIndex);
}

DatePicker.prototype.getDateFromSelectedIndex = function() {
	var selectedDate = this.newDateFromDateAndDiffDays(this.centralDate, 
		this.selectedIndex-3);
		
	var selectedDateString = this.daysArray[selectedDate.getDay()] + ", "
		+ selectedDate.getDate() + " " + this.monthsArray[selectedDate.getMonth()] 
